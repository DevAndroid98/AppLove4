...
public class DongHoTinhYeuService extends Service {
    ...
    private void getDataName() {
        ...
        if (cursor.moveToNext()) {
            ...
            txtNoiDung.setText(nameboy+"❤"+datelove+"_date_love❤"+namegirl);
        }
    }
    private void hien(){
        ...
        txtNoiDung.setAnimation(animation);
    ...
    private void an(){
        Animation animation= AnimationUtils.loadAnimation(this, R.anim.anim6);
        linearLayout.setAnimation(animation);
        date.setAnimation(animation);
        txtNoiDung.setAnimation(animation);
